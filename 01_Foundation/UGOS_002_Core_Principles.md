...
Document ID: UGOS_002_Core_Principles
...
# UGOS_002: Core Principles & Operational Invariants
...
*   **Implementation Rule:** State transitions to L4 or L5 tool calls automatically trigger `WAITING_APPROVAL` task status and freeze execution until authorized.
