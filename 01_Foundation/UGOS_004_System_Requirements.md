...
Document ID: UGOS_004_System_Requirements
...
# UGOS_004: Functional System Requirements
...
*   **FR-004:** The Planning Engine shall generate executable Directed Acyclic Graphs (DAGs) for any task exceeding complexity threshold `T_plan`.
...
*   **FR-010:** UGOS shall halt execution and transition to `WAITING_APPROVAL` status when a task requests L4 or L5 action scopes.
